...
<footer class="site-footer">
    <div class="footer-container">
        ...
        <div class="footer-copyright">
            <p>&copy; <?php echo date('Y'); ?> ONYX. All rights reserved</p>
        </div>
        ...
        <div class="footer-socials">
            ...
            <a href="#" class="social-link" aria-label="Facebook">
                <svg viewBox="0 0 24 24"><path d="M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 0 .955.042 1.468.103a8.68 8.68 0 0 1 1.141.195v3.325a8.623 8.623 0 0 0-.653-.036c-2.148 0-2.971.956-2.971 3.035v.938h4.083l-1.39 3.666h-2.693v7.98h-4.843z"></path></svg>
            </a>
    ...
    <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="footer-links">
            <?php
            // Hiển thị menu footer nếu có, nếu không thì hiện HTML cứng
            if (has_nav_menu('footer')) {
                ...
                // Link mặc định giống thiết kế nếu chưa cài menu
