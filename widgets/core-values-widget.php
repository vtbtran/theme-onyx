...
class Onyx_Core_Values_Widget extends \Elementor\Widget_Base {
    ...
    public function get_name() { return 'onyx_core_values'; }
    public function get_title() { return 'Onyx: Core Values'; }
    public function get_icon() { return 'eicon-diamond'; }
    ...
    protected function _register_controls() {
        ...
        // 2. Danh sách giá trị (Repeater)
        $repeater = new \Elementor\Repeater();

        // Control chọn Icon (SVG)
