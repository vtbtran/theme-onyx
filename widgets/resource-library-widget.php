...
class Onyx_Resource_Library_Widget extends \Elementor\Widget_Base {
    ...
    public function get_name() { return 'onyx_resource_library'; }
    public function get_title() { return 'Onyx: Resource Library'; }
            ...
            <section class="res-featured-section">
                <div class="container">
                    ...
                    <div class="res-grid" id="res-grid-<?php echo esc_attr($unique_id); ?>">
                                ...
                                <div class="res-body">
                                    ...
                                    <div class="res-footer">
                                        ...
                                        <a href="<?php echo esc_url($item['res_link']['url']); ?>" class="btn-download">
                                            <span class="icon-box-dark-sm"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="7" y1="7" x2="17" y2="17"></line><polyline points="17 7 17 17 7 17"></polyline></svg></span>
                        ...
                        <?php endforeach; endif; ?>
                        <div class="no-res-msg" style="display:none; grid-column: 1/-1; text-align: center; color: #666; padding: 40px;"><h3>No resources found.</h3></div>
                    </div>
                    <?php if(!empty($settings['view_news_text'])): ?>
                    <div class="res-view-news-wrap">
                        <a href="<?php echo esc_url($settings['view_news_link']['url']); ?>" class="btn-view-news"><span class="icon-box-square-white"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="7" y1="7" x2="17" y2="17"></line><polyline points="17 7 17 17 7 17"></polyline></svg></span><?php echo esc_html($settings['view_news_text']); ?></a>
                    </div>
                    <?php endif; ?>
                </div>
            </section>
        ...
        if (typeof onyxRunFilter !== 'function') {
            function onyxRunFilter(uid) {
                ...
                for (var i = 0; i < cards.length; i++) {
                    ...
                    if (matchCat && matchSearch) { card.style.display = 'flex'; count++; } else { card.style.display = 'none'; }
                }
                if(count === 0) noMsg.style.display = 'block'; else noMsg.style.display = 'none';
            }
            ...
            function onyxCheckEnter(e, uid) { if (e.keyCode === 13) { onyxRunFilter(uid); } }
        }
        </script>
        <?php
    }
