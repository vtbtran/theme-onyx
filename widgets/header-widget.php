...
if (! class_exists('Onyx_Header_Widget')) {
    ...
    class Onyx_Header_Widget extends \Elementor\Widget_Base
    {
        ...
        {
            return 'onyx_header_widget';
        }
        public function get_title()
        {
            return 'Onyx Header (Full Option)';
        } // Đổi tên chút cho ngầu
        ...
        {
            $this->start_controls_section('section_content', ['label' => 'Header Configuration']);

            // 1. Logo Control
            $this->add_control('custom_logo', [
                'label' => 'Logo',
                'type' => \Elementor\Controls_Manager::MEDIA,
                'description' => 'Leave empty to use the default website logo.',
            ]);

            // 2. Menu Control
            // Get a list of all existing menus in the website
            $menus = wp_get_nav_menus();
            $menu_options = ['' => 'Default (Primary Menu)']; // Default option
            ...
            $this->add_control('selected_menu', [
                ...
                'default' => '',
                'description' => 'Choose the menu set you want to display in the center.',
            ]);
