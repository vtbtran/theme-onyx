...
class Home_Hero_Widget extends \Elementor\Widget_Base {
    ...
    public function get_name() { return 'home_hero_widget'; }
    public function get_title() { return 'Home Hero Section'; }
    public function get_icon() { return 'eicon-slides'; }
    public function get_categories() { return [ 'general' ]; }

    protected function _register_controls() {
        // --- NỘI DUNG TRÁI ---
        $this->start_controls_section('content_left_section', ['label' => 'Nội dung bên trái', 'tab' => \Elementor\Controls_Manager::TAB_CONTENT]);
        
        $this->add_control('hero_main_title', [
            'label' => 'Tiêu đề chính', 
            'type' => \Elementor\Controls_Manager::TEXTAREA, 
            'default' => 'Innovating <br> Tomorrow, Today',
            'description' => 'Dùng thẻ <br> để xuống dòng.'
        ]);
        
        $this->add_control('hero_bottom_title', [
            'label' => 'Tiêu đề phụ (Vàng)', 
            'type' => \Elementor\Controls_Manager::TEXT, 
            'default' => 'Technology & <br> Education Solutions' // Đã thêm <br> cho giống mẫu
        ]);
        ...
        $repeater->add_control('slide_image', ['label' => 'Ảnh', 'type' => \Elementor\Controls_Manager::MEDIA, 'default' => ['url' => \Elementor\Utils::get_placeholder_image_src()]]);
        $repeater->add_control('slide_title', ['label' => 'Tiêu đề', 'type' => \Elementor\Controls_Manager::TEXT, 'default' => 'Empowering Through Education']);
        $repeater->add_control('slide_cat', ['label' => 'Danh mục', 'type' => \Elementor\Controls_Manager::TEXT, 'default' => 'Learning & Development']);
        $repeater->add_control('slide_desc', ['label' => 'Mô tả', 'type' => \Elementor\Controls_Manager::TEXTAREA, 'default' => 'We create engaging educational experiences...']);
        $repeater->add_control('slide_btn_text', ['label' => 'Nút', 'type' => \Elementor\Controls_Manager::TEXT, 'default' => 'About Us']);
        ...
        $this->add_control('slides', [
            ...
            // Dữ liệu mẫu ban đầu để kéo ra là thấy đẹp ngay
            'default' => [
                [
