...
class Onyx_Contact_Intro_Widget extends \Elementor\Widget_Base {
    ...
    public function get_name() { return 'onyx_contact_intro'; }
    public function get_title() { return 'Onyx: Contact Intro'; }
    ...
    protected function _register_controls() {
        ...
        $this->add_control('icon_svg', [
            ...
            'description' => 'Nhập mã SVG vào đây.',
        ]);
