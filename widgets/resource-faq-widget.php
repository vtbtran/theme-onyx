...
class Onyx_FAQ_Widget extends \Elementor\Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        // --- SECTION HEADER ---
        $this->start_controls_section('sec_header', ['label' => 'Header', 'tab' => \Elementor\Controls_Manager::TAB_CONTENT]);
        ...
        // --- FAQ ITEMS ---
        $this->start_controls_section('sec_items', ['label' => 'FAQ Items', 'tab' => \Elementor\Controls_Manager::TAB_CONTENT]);
        ...
        $repeater->add_control('question', [
            'label' => 'Question',
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => 'How do i access premium resources?'
        ]);

        $repeater->add_control('answer', [
            'label' => 'Answer',
            'type' => \Elementor\Controls_Manager::TEXTAREA,
            'default' => 'Premium resources are available to customers with active support contracts...'
        ]);
