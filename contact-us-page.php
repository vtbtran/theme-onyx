        ...
        <div class="container features-grid">
            <div class="feature-item">
                <span class="feat-icon">
                    <img
                        src="<?php echo get_template_directory_uri(); ?>/assets/images/Vector.png"
                        alt="Feature icon">
                </span>
            ...
            <div class="feature-item">
                <span class="feat-icon">
                    <img
                        src="<?php echo get_template_directory_uri(); ?>/assets/images/Vector (1).png"
                        alt="Feature icon">
                </span>
            ...
            <div class="feature-item">
                <span class="feat-icon">
                    <img
                        src="<?php echo get_template_directory_uri(); ?>/assets/images/Vector (2).png"
                        alt="Feature icon">
                </span>
